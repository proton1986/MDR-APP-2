  ...
  return (
    <main className="flex-1 overflow-y-auto p-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">Create, read, update, and delete videos</p>
      </div>

      <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
        <i className="fas fa-video text-6xl text-blue-950 mb-4"></i>
        <h2 className="text-2xl font-bold text-blue-950 mb-2">Video Management</h2>
        <p className="text-gray-600 mb-4">This feature will be implemented soon.</p>
        <div className="bg-blue-50 rounded-lg p-4">
          <p className="text-sm text-blue-800">
            <i className="fas fa-info-circle mr-2"></i>
            Video management functionality is coming in the next update.
          </p>
        </div>
      </div>
    </main>
